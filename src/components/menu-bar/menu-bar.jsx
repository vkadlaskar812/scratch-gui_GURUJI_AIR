...
import BoardSelectorModal from '../board-selector/board-selector-modal.js';
...
const MenuItemTooltip = ({ id, isRtl, children, className }) => (
    <div className={classNames(styles.menuItemTooltip, className)}>
        {children}
    </div>
);
...
class MenuBar extends React.Component {
    ...
    handleSelectBoard = (board) => {
        this.setState({ selectedBoard: board, isBoardSelectorOpen: false });
    ...
    render() {
        ...
        //blur background
        const blurBackgroundClass = this.state.showBoardSelector ? 'blur-background' : '';
        return (
            <Box
                className={classNames(
            ...
            >
                <div className={styles.mainMenu}>
                    <div className={styles.fileGroup}>
                        ...
                        <div
                            className={classNames(styles.menuBarItem, styles.hoverable, {
                                [styles.active]: this.props.selectBoard,
                                'blur': this.state.isBoardSelectorOpen
                            })}
                            onClick={() => {
                                this.setState({ isBoardSelectorOpen: true });
                            }}
                        >
                            <FormattedMessage
                        ...
                        <BoardSelectorModal
                            isOpen={this.state.isBoardSelectorOpen}
                            onCloseModal={() => this.setState({ isBoardSelectorOpen: false })}
                        ...
                        {(this.props.canManageFiles) && (
                            ...
                            >
                                <FormattedMessage
                                    ...
                                    description="Connect to the board"
                ...
                <div className={styles.accountInfoGroup}>
                    ...
                    {this.props.sessionExists ? (
                        this.props.username ? (
                            ...
                            <React.Fragment>
                                ...
                                <div className={classNames(styles.menuBarItem, styles.hoverable)}>
                                    <FormattedMessage
                                        ...
                                        description="Link for signing out of your Scratch account"
                            ...
                            // so they can choose to log in or join
                            <React.Fragment>
                                <div
                                    className={classNames(
                                        styles.menuBarItem,
